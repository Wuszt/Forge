...
namespace d3d11
{
	...
	public:
		...
		virtual void UpdateRenderableECSArchetype( ecs::MutableArchetypeView archetype, std::function<const renderer::Renderable&(Uint32)> renderableGetter) const override;
